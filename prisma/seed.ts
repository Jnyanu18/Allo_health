  ...
  const products = await Promise.all([
    prisma.product.create({
      data: {
        name: "Tadalafil 10mg",
        sku: "MED-TAD10",
        description: "Clinically proven treatment for ED. Long-lasting up to 36 hours.",
        price: 499,
        imageUrl: "https://images.unsplash.com/photo-1584308666744-24d5e478eb13?w=400",
      },
    }),
    prisma.product.create({
      data: {
        ...
        sku: "MED-SIL50",
        description: "Fast-acting ED treatment. Effects start within 30-60 minutes.",
        price: 399,
        imageUrl: "https://images.unsplash.com/photo-1584308666744-24d5e478eb13?w=400",
      },
    }),
    ...
    prisma.product.create({
      data: {
        ...
        sku: "SUPP-TEST",
        description: "Natural herbal blend to support healthy testosterone levels.",
        price: 899,
    ...
    prisma.product.create({
      data: {
        ...
        sku: "SUPP-ASHWA",
        description: "Premium ashwagandha extract to reduce stress and boost vitality.",
        price: 649,
        imageUrl: "https://images.unsplash.com/photo-1628771065518-0d82f1938462?w=400",
      },
    }),
    ...
    prisma.product.create({
      data: {
        ...
        sku: "MED-SPRAY",
        description: "Desensitizing spray for enhanced endurance and performance.",
        price: 349,
        imageUrl: "https://images.unsplash.com/photo-1584308666744-24d5e478eb13?w=400",
      },
    }),
